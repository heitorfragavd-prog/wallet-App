...
export const useReceitas = (params: ReceitasQueryParams = {}) => {
  ...
  const createReceita = useMutation({
    ...
    onError: (error) => {
      ...
      toast({ title: "Erro ao criar receita", description: error instanceof Error ? error.message : (typeof error === 'object' && error !== null && 'message' in error ? String((error as Record<string, unknown>).message) : String(error)), variant: "destructive" });
    },
  });
  ...
  const updateReceita = useMutation({
    ...
    onError: (error) => {
      ...
      toast({ title: "Erro ao atualizar receita", description: error instanceof Error ? error.message : (typeof error === 'object' && error !== null && 'message' in error ? String((error as Record<string, unknown>).message) : String(error)), variant: "destructive" });
    },
  });
  ...
  const deleteReceita = useMutation({
    ...
    onError: (error) => {
      ...
      toast({ title: "Erro ao remover receita", description: error instanceof Error ? error.message : (typeof error === 'object' && error !== null && 'message' in error ? String((error as Record<string, unknown>).message) : String(error)), variant: "destructive" });
    },
  });
