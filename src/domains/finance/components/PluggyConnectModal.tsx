...
import { ShieldCheck, RefreshCw, CheckCircle2, Building2, Lock, Search, AlertCircle, Sparkles, ArrowRight } from "lucide-react";
              ...
              isLoadingToken && !connectToken ? (
                ...
                <div className="p-6 bg-rose-500/10 border border-rose-500/30 rounded-2xl space-y-2 text-center">
                  ...
                  <Button
                    ...
                    className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-xs h-9 mt-2"
                  >
                    Ir para Seleção Direta de Bancos
                  </Button>
                </div>
              ) : (
