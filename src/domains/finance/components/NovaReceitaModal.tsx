...
export const NovaReceitaModal: React.FC<NovaReceitaModalProps> = ({
  isOpen,
  onClose,
}) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="Ex: Salário, Pix recebido, Venda..."
          ...
          <div className="flex justify-end pt-2">
            <Button
              type="submit"
              disabled={loading}
              className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold px-6 h-11 rounded-2xl shadow-lg shadow-emerald-500/25 w-full"
            >
